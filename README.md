...
> Access an Array: To access an array, the runtime complexity would be 0(1).

> Add or Remove from the front: To add or remove from the front of an array, the runtime complexity would be 0(n).
